...
system ".\\words.pl";
$bpdb =     "C:/Program Files (x86)/Half Life 2/root/cstrike/BotProfile.db"; # What we read from to get names
$namefile = "./names.txt"; # What we're writing to for names
$header1 =  "C:/Program Files (x86)/Half Life 2/root/cstrike/header1.txt";
$header2 =  "C:/Program Files (x86)/Half Life 2/root/cstrike/header2.txt";
...
close BPDB;
$cnt = 0;
system("\"C:\\Program Files \(x86\)\\Half Life 2\\root\\hl2.exe\" -steamlocal -game cstrike");
# Functions
sub templategen{
	foreach my $tt (@order){
    foreach (@{$tt}){
